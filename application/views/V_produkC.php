   ...
   <table id="example2" class="table table-bordered table-striped">
    ...
    foreach ($data_produk_c as $tampilProduk):
      ...
      <tr>
        ...
        <td onclick="javascript: return confirm('Anda yakin hapus?')"><?php echo anchor('produkC/hapusTabel/'.$tampilProduk->id_produk, '<div class="btn btn-danger btn-sm" ><i class="fa fa-trash"></i></div>' ) ?> </td> 
        <td><?php echo anchor('produkC/editTabel/'.$tampilProduk->id_produk,'<div class="btn btn-primary btn-sm" ><i class="fa fa-edit"></i></div>')?></td>  
      </tr>
    <?php endforeach; ?>
  </table>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url(). 'produkC/tambahTabel';?>">
