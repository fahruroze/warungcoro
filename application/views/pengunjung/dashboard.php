...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/open-iconic-bootstrap.min.css">
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/owl.theme.default.min.css">
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/magnific-popup.css">

  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/aos.css">

  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/ionicons.min.css">

  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/bootstrap-datepicker.css">
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/jquery.timepicker.css">


  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/flaticon.css">
  <link rel="stylesheet" href="<?php echo base_url() ?>assets/template/front/css/icomoon.css">
...
<body>
        ...
        <div class="col-lg-12 d-block">
          <div class="row d-flex">
            <div class="col-md pr-4 d-flex topper align-items-center">
              ...
              <span class="text">087 724 888 424</span>
            </div>
            <div class="col-md pr-4 d-flex topper align-items-center">
              <div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
              <span class="text">fanyfahrurozi@gmail.com</span>
            </div>
            <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right justify-content-end">
              <p class="mb-0 register-link"><span>Buka Jam:</span> <span>Senin - Jumat</span> <span>7:00 Esuk - 17:00 Sore</span></p>
            </div>
          </div>
        </div>
      </div>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="index.html">Waroengku</a>
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active"><a href="index.html" class="nav-link">Deleng Waroengku!</a></li>
          <li class="nav-item"><a href="about.html" class="nav-link">Kepriwe sih?</a></li>
          <li class="nav-item"><a href="menu.html" class="nav-link">Kih Dagangane!</a></li>
          <li class="nav-item"><a href="blog.html" class="nav-link">Berita Anyar!</a></li>
          <li class="nav-item"><a href="contact.html" class="nav-link">Nomer HP?</a></li>
          <li class="nav-item cta"><a href="reservation.html" class="nav-link">Pengen Pesen!</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <section class="home-slider owl-carousel js-fullheight">
    <div class="slider-item js-fullheight" style="background-image: url(<?php echo base_url() ?>assets/template/front/images/bg_1.jpg);">
      <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 col-sm-12 text-center ftco-animate">
            <h1 class="mb-4 mt-5">Waroeng Acong</h1>
    ...
    <div class="slider-item js-fullheight" style="background-image: url(images/bg_2.jpg);">
      ...
      <div class="container">
        <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 col-sm-12 text-center ftco-animate">
            <h1 class="mb-4 mt-5">Waroeng Kopsis</h1>
            <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
          </div>
    ...
    <div class="slider-item js-fullheight" style="background-image: url(images/bg_3.jpg);">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 col-sm-12 text-center ftco-animate">
            <h1 class="mb-4 mt-5">Waroeng <span> </span> Seblak</h1>
            <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
          </div>
    ...
    <div class="slider-item js-fullheight" style="background-image: url(images/bg_3.jpg);">
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 col-sm-12 text-center ftco-animate">
            <h1 class="mb-4 mt-5">Waroeng Pojok</h1>
            <p><a href="#" class="btn btn-primary p-3 px-xl-4 py-xl-3">Order Now</a> <a href="#" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">View Menu</a></p>
          </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-sm-10 wrap-about ftco-animate text-center">
          ...
          <p>Waroengku iku sistem inpormasi soal warung-warung sing ana ning Polindra</p>
