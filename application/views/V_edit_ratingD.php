...
<div class="content-wrapper">
	<section class="content">
		<?php foreach($edit_rating_d as $tampilRating) {?>

		<form action="<?php echo base_url().'ratingD/update/'?>" method='post'>
			...
			<a href="<?php echo base_url().'ratingD'; ?>" type="button" class="btn btn-danger">Reset</a>
