...
<div class="content-wrapper">
	<section class="content">
		<?php foreach($edit_rating_c as $tampilRating) {?>

		<form action="<?php echo base_url().'ratingC/update/'?>" method='post'>
			...
			<a href="<?php echo base_url().'ratingC'; ?>" type="button" class="btn btn-danger">Reset</a>
